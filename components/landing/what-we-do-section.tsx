...
export function WhatWeDoSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative py-16 lg:py-24 bg-background border-t border-border/50"
    >
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        <div
          className={`max-w-2xl mb-10 transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
        >
