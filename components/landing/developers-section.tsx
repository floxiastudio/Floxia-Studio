...
const codeExamples = [
  {
    label: "Install",
    code: `npm install @floxiastudio/sdk

# or
yarn add @floxiastudio/sdk
pnpm add @floxiastudio/sdk`,
  },
  {
    label: "Initialize",
    code: `import { Floxia } from '@floxiastudio/sdk'

const floxia = new Floxia({
  apiKey: process.env.FLOXIA_KEY
})`,
  },
  {
    label: "Deploy",
    code: `const app = await floxia.deploy({
  name: 'my-app',
  region: 'auto',
  scaling: {
    min: 1,
