  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        >
          <div className="flex items-center justify-center gap-3 text-sm font-mono text-muted-foreground mb-4">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            We've engineered our process to remove every common pain point
            associated with web development projects missed deadlines, generic
            designs, poor communication, and sites that fail to perform.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-3 font-display tracking-tight text-foreground">
                {feature.title}
              </h3>
