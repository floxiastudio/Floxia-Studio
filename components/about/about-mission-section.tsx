...
export function AboutMissionSection() {
  ...
  return (
    <section ref={ref} className="relative py-24 lg:py-36 bg-foreground text-primary-foreground overflow-hidden">
      {/* Decorative circle */}
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className={`max-w-3xl mb-16 lg:mb-20 transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <p className="text-lg text-primary-foreground/70 leading-relaxed max-w-2xl">
            Our Mission: To empower businesses with world-class digital experiences that drive
            measurable growth, built with technical excellence and genuine creative ambition.
          </p>
        </div>
          ...
          {values.map((v, i) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="font-display text-xl text-primary-foreground mb-3">{v.title}</h3>
                <p className="text-sm text-primary-foreground/60 leading-relaxed">{v.body}</p>
              </div>
            );
          })}
        </div>
